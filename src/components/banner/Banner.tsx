        ...
        <Container>
            <Flex>
                <div className="w-1/2">
                    ...
                    <p className="text-[20px] font-normal font-anek max-w-[457px] pt-[15px] py-[45px]">আইটি ট্রেনিং এর মাধ্যমে নিজেকে স্বাবলম্বী করুন। নিজেকে আইটি এক্সপার্ট হিসেবে গড়ে তুলুন</p>
